...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze=ImageIO.read(getClass().getResource("starboy2.jpg"));
		//3. Set the mouse pointer to the start of your maze using:
		new Robot().mouseMove(127, 460	);
	...
	if(-1==mouseColor) {
		...
		if(-15790834==mouseColor) {
			JOptionPane.showMessageDialog(null,"You Dindn't Loose!");
		}
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("Turn Down for What - MLG Airhorn Remix.wav"));
